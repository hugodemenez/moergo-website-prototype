...
export default function Page() {
  return (
    <main>
      ...
      <FeaturedProducts />
      <section className="py-12 flex justify-between w-full relative gap-12">
        <div className="space-y-6 min-h-[450px] w-full md:w-fit">
          <div>
          ...
          <div className="space-y-4 text-foreground max-w-xl">
            <p>
              There is no one correct answer for everyone, but the short answer
              is:
            </p>
            ...
            <p>
              No matter which one(s) you choose, your choice is always backed by
              MoErgo.
            </p>
          </div>
        </div>
